...
# given an array representing the water level in different sections of a water tank.
# Update: Update the water level at a specific section of the tank.
# Query: Find the total water level in a given range of sections.